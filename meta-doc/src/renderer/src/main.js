...
import { initServiceStatusWatcher } from './utils/common/service-status'
...
import { registerUnitTests } from './utils/testing/unit-tests-register.ts'
import { initializeFormats } from './utils/editor/format-initializer'
