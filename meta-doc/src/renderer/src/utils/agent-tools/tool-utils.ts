 ...
 */
export function parsePartialJsonArray(jsonStr: string): {
  success: boolean
  data?: any[]
  error?: string
  partial?: boolean
 ...
 */
export function parseJsonWithClean<T = any>(
  jsonStr: string
): { success: boolean; data?: T; error?: string; partial?: boolean } {
