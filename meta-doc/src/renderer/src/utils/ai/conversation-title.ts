 ...
 */
import { ref } from 'vue'
import { updateTitlePrompt } from '../common/prompts'
import { createAiTask, ai_types } from './ai_tasks'
import { parseSchemaJson, DOCUMENT_TITLE_SCHEMA, type DocumentTitleSchemaResult } from '../common/schemas'
import { createRendererLogger } from '../common/logger'
