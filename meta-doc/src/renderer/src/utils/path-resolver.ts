 ...
 * ```
 */
export function resolvePathWithLinkBase(relativePath: string, linkBase: string): string {
 ...
 * @returns 解析后的绝对路径数组
 */
export function resolveRelativePaths(relativePaths: string[], basePath: string): string[] {
 ...
 * @returns 解析后的绝对路径数组
 */
export function resolvePathsWithLinkBase(relativePaths: string[], linkBase: string): string[] {
