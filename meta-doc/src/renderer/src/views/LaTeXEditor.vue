              ...
              <div class="latex-column left-column">
                ...
                <div class="editor-console-container" ref="editorConsoleContainerRef">
                  ...
                  >
                    ...
                    >
                      <XtermConsoleLatex
                        ref="xtermConsoleLatexRef"
                        :initial-directory="currentPath ? dirname(currentPath.replace(/^file:\/\/\//, '')) : ''"
...
const xtermConsoleLatexRef = ref<InstanceType<typeof XtermConsoleLatex> | null>(null)
...
const compile = async () => {
  ...
  if (isDemo.value) {
    ...
    xtermConsoleLatexRef.value?.createCompileSession()
    ...
    showPdfPanel.value = true
    xtermConsoleLatexRef.value?.finishCompileSession()
