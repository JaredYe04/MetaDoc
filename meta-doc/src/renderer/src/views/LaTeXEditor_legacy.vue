...
import { addDialog, countNodes, current_article, current_article_meta_data, current_file_path, current_tex_article, defaultAiChatMessages, latest_view, renderedHtml, searchNode, sync } from "../utils/obsolete/common-data";
import { extractOutlineTreeFromMarkdown } from '../utils/md-utils';
import { current_outline_tree } from '../utils/obsolete/common-data';
