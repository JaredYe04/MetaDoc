...
\subsection{格式与交叉引用示例}
以下为行内公式、带编号公式、插图、表格、文献引用与脚注的示例，撰写正文时可参考或删除。行内公式如 $E=mc^2$；带编号公式：
\begin{equation}
  \label{eq:gb}
  \nabla \cdot \mathbf{E} = \frac{\rho}{\varepsilon_0}.
\end{equation}
可引用式~\ref{eq:gb}。图~\ref{fig:gb} 与表~\ref{tab:gb} 为占位示例；文中引用文献见\cite{ref1}，脚注示例\footnote{脚注内容。}。
\begin{figure}[htbp]
  \centering
  \rule{3.5cm}{2cm}
  \caption{示例图。}
