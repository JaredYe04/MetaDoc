                    ...
                    <el-scrollbar class="kb-search-wrapper" style="flex: 0 0 40%;">
                        <el-card class="kb-panel" shadow="hover"
                            ...
                            <el-scrollbar style="flex-grow: 1; margin-top: 10px; min-height: 0;">
                                <el-card class="kb-result-card" shadow="hover" v-for="(result, index) in searchResults"
                                    :key="index"
                ...
                <div class="kb-right" :style="{ background: themeState.currentTheme.background }">
                    ...
                    <el-card class="kb-panel kb-preview" shadow="hover" v-loading="!previewLoaded"
                        ...
                        <div class="preview-container" v-if="previewText">
                            <div :id="previewEditorId" class="monaco-editor-container" :key="previewEditorId"></div>
                        </div>
                            ...
                            <div v-if="selectedItem" class="config-content">
                                <el-descriptions column="1" size="small" border
                                    :style="{ 
                                        ...
                                        '--el-descriptions-item-bordered-label-background': themeState.currentTheme.SideBackgroundColor,
                                        '--el-descriptions-item-bordered-label-color': themeState.currentTheme.SideTextColor,
                                        '--el-descriptions-item-bordered-content-background': themeState.currentTheme.background2nd,
                                        '--el-descriptions-item-bordered-content-color': themeState.currentTheme.textColor
                                    }">
                                    ...
                                    <el-descriptions-item :label="t('knowledgeBase.enabled_state')">
                                        <el-switch v-if="selectedItem && selectedItem.info" v-model="selectedItem.info.enabled"
