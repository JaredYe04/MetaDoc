<template>
  <div class="profile-root" :class="{ 'profile-root--embedded': embedded }">
        ...
        <transition name="fade-slide" mode="out-in">
          <div v-if="currentStep === 0" key="step-0" class="step-content">
            ...
            <RadioGroup v-model="form.scenario" class="radio-button-group flex-wrap">
              <div class="flex items-center">
                <RadioGroupItem id="wps-scenario-student" value="student" class="sr-only peer" />
                <label
                  for="wps-scenario-student"
              ...
              <div class="flex items-center">
                <RadioGroupItem
                  id="wps-scenario-researcher"
                  value="researcher"
                  class="sr-only peer"
                />
                <label
                  for="wps-scenario-researcher"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
                  <div class="radio-content">
              ...
              <div class="flex items-center">
                <RadioGroupItem id="wps-scenario-it" value="it" class="sr-only peer" />
                <label
                  for="wps-scenario-it"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
              ...
              <div class="flex items-center">
                <RadioGroupItem id="wps-scenario-office" value="office" class="sr-only peer" />
                <label
                  for="wps-scenario-office"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
                  <div class="radio-content">
              ...
              <div class="flex items-center">
                <RadioGroupItem id="wps-scenario-other" value="other" class="sr-only peer" />
                <label
                  for="wps-scenario-other"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
                  <div class="radio-content">
          ...
          <div v-else-if="currentStep === 1" key="step-1" class="step-content">
            ...
            <RadioGroup v-model="form.markdownLevel" class="radio-button-group flex-wrap">
              <div class="flex items-center">
                <RadioGroupItem id="wps-md-level-0" :value="0" class="sr-only peer" />
                <label
                  for="wps-md-level-0"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
              ...
              <div class="flex items-center">
                <RadioGroupItem id="wps-md-level-1" :value="1" class="sr-only peer" />
                <label
                  for="wps-md-level-1"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
              ...
              <div class="flex items-center">
                <RadioGroupItem id="wps-md-level-2" :value="2" class="sr-only peer" />
                <label
                  for="wps-md-level-2"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
              ...
              <div class="flex items-center">
                <RadioGroupItem id="wps-md-level-3" :value="3" class="sr-only peer" />
                <label
                  for="wps-md-level-3"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
          ...
          >
            ...
            <FormField :label="$t('userManual.profile.usedWysiwygMarkdown')" name="">
              ...
              <RadioGroup v-model="form.usedWysiwygMarkdown" class="radio-button-group flex-wrap">
                <div class="flex items-center">
                  <RadioGroupItem id="wps-used-wysiwyg-yes" :value="true" class="sr-only peer" />
                  <label
                    for="wps-used-wysiwyg-yes"
                    class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                  >
                    <div class="radio-content">
                ...
                <div class="flex items-center">
                  <RadioGroupItem id="wps-used-wysiwyg-no" :value="false" class="sr-only peer" />
                  <label
                    for="wps-used-wysiwyg-no"
                    class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                  >
                    <div class="radio-content">
            ...
            <FormField :label="$t('userManual.profile.usedOtherMarkdownEditor')" name="">
              ...
              >
                <div class="flex items-center">
                  <RadioGroupItem id="wps-used-other-md-yes" :value="true" class="sr-only peer" />
                  <label
                    for="wps-used-other-md-yes"
                    class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                  >
                    <div class="radio-content">
                      <span>{{ $t('userManual.profile.yes') }}</span>
                ...
                <div class="flex items-center">
                  <RadioGroupItem id="wps-used-other-md-no" :value="false" class="sr-only peer" />
                  <label
                    for="wps-used-other-md-no"
                    class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                  >
                    <div class="radio-content">
                      <span>{{ $t('userManual.profile.no') }}</span>
          ...
          >
            ...
            <RadioGroup v-model="form.latexLevel" class="radio-button-group flex-wrap">
              <div class="flex items-center">
                <RadioGroupItem id="wps-latex-level-0" :value="0" class="sr-only peer" />
                <label
                  for="wps-latex-level-0"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
                  <div class="radio-content">
                    <span>{{ $t('userManual.profile.levels.none') }}</span>
              ...
              <div class="flex items-center">
                <RadioGroupItem id="wps-latex-level-1" :value="1" class="sr-only peer" />
                <label
                  for="wps-latex-level-1"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
                  <div class="radio-content">
                    <span>{{ $t('userManual.profile.levels.basic') }}</span>
              ...
              <div class="flex items-center">
                <RadioGroupItem id="wps-latex-level-2" :value="2" class="sr-only peer" />
                <label
                  for="wps-latex-level-2"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
                  <div class="radio-content">
                    <span>{{ $t('userManual.profile.levels.intermediate') }}</span>
              ...
              <div class="flex items-center">
                <RadioGroupItem id="wps-latex-level-3" :value="3" class="sr-only peer" />
                <label
                  for="wps-latex-level-3"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
                  <div class="radio-content">
                    <span>{{ $t('userManual.profile.levels.advanced') }}</span>
          ...
          >
            ...
            <FormField :label="$t('userManual.profile.usedLatexEditor')" name="">
              ...
              <RadioGroup v-model="form.usedLatexEditor" class="radio-button-group flex-wrap">
                <div class="flex items-center">
                  <RadioGroupItem id="wps-used-latex-yes" :value="true" class="sr-only peer" />
                  <label
                    for="wps-used-latex-yes"
                    class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                  >
                    <div class="radio-content">
                      <span>{{ $t('userManual.profile.yes') }}</span>
                ...
                <div class="flex items-center">
                  <RadioGroupItem id="wps-used-latex-no" :value="false" class="sr-only peer" />
                  <label
                    for="wps-used-latex-no"
                    class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                  >
                    <div class="radio-content">
                      <span>{{ $t('userManual.profile.no') }}</span>
          ...
          >
            ...
            <RadioGroup v-model="form.agentLevel" class="radio-button-group flex-wrap">
              <div class="flex items-center">
                <RadioGroupItem id="wps-agent-level-0" :value="0" class="sr-only peer" />
                <label
                  for="wps-agent-level-0"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
                  <div class="radio-content">
              ...
              <div class="flex items-center">
                <RadioGroupItem id="wps-agent-level-1" :value="1" class="sr-only peer" />
                <label
                  for="wps-agent-level-1"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
                  <div class="radio-content">
              ...
              <div class="flex items-center">
                <RadioGroupItem id="wps-agent-level-2" :value="2" class="sr-only peer" />
                <label
                  for="wps-agent-level-2"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
                  <div class="radio-content">
              ...
              <div class="flex items-center">
                <RadioGroupItem id="wps-agent-level-3" :value="3" class="sr-only peer" />
                <label
                  for="wps-agent-level-3"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
                  <div class="radio-content">
              ...
              <div class="flex items-center">
                <RadioGroupItem id="wps-agent-level-4" :value="4" class="sr-only peer" />
                <label
                  for="wps-agent-level-4"
                  class="radio-option peer-data-[state=checked]:bg-primary peer-data-[state=checked]:text-primary-foreground"
                >
                  <div class="radio-content">
    ...
    <div class="dialog-footer">
      <Button v-if="showSkipButton" variant="ghost" @click="handleCancel">{{
        $t('userManual.profile.skip')
      }}</Button>
      <div v-else class="footer-spacer" />
      <div class="footer-actions">
        <Button v-if="currentStep > 0" variant="outline" @click="prevStep">{{
          $t('userManual.profile.prev')
        }}</Button>
        ...
        <Button v-if="currentStep === maxStep" :disabled="!canSubmit" @click="handleSubmit">
          {{ submitLabel || $t('userManual.profile.submit') }}
        </Button>
      </div>
    </div>
  </div>
...
const props = withDefaults(
  defineProps<{
    ...
    /** 最后一步按钮文案（如「完成问卷，继续」） */
    submitLabel?: string
    /** true：仅 emit profile，不写盘、不调用 setUserManual（由向导统一提交） */
...
<style scoped>
.profile-root--embedded .profile-container {
  min-height: 280px;
}
...
.profile-root--embedded .form-content-wrapper {
  min-height: 220px;
}
