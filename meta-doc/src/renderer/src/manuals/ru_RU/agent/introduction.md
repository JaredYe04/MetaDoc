...
Подробнее см. [[agent.config|Управление конфигурацией Agent]].
...
Подробнее см. [[agent.references|Управление ссылочными материалами]].
...
Подробнее см. [[agent.engine|Управление движком Agent]].
...
2. [[agent.config|Управление конфигурацией Agent]]: узнайте, как настраивать агента.
3. [[agent.tools|Управление наборами инструментов]]: научитесь управлять наборами инструментов.
4. [[agent.session|Управление сессиями Agent]]: создавайте и управляйте сессиями.
5. [[agent.references|Управление ссылочными материалами]]: управляйте ссылочными материалами.
6. [[agent.engine|Управление движком Agent]]: выбирайте и настраивайте движки.
...
- [[agent.config|Управление конфигурацией Agent]]
- [[agent.tools|Управление наборами инструментов]]
- [[agent.references|Управление ссылочными материалами]]
