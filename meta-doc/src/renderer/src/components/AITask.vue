        ...
        <div style="display: flex; flex-direction: column; gap: 8px;">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <div style="flex: 1;">
                    ...
                    <span :style="{
                        color: taskStatus === ai_task_status.FAILED ? 'var(--el-color-danger)' : 
                               taskStatus === ai_task_status.CANCELLED ? 'var(--el-color-warning)' :
                               taskStatus === ai_task_status.FINISHED ? 'var(--el-color-success)' :
                               'inherit'
                    }">
                ...
                <div style="display: flex; gap: 6px;">
                    <el-button size="small" type="success" v-if="taskStatus === ai_task_status.READY" circle
                        @click="$emit('start')">
            ...
            <!-- 显示错误信息 -->
            <div v-if="taskStatus === ai_task_status.FAILED && task.error" 
                 style="padding: 8px; background-color: var(--el-color-danger-light-9); border-radius: 4px; font-size: 12px; color: var(--el-color-danger);">
