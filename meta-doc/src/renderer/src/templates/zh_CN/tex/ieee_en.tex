...
\subsection{Format examples: equations, figures, tables, citations, footnotes}
Inline math: $E=mc^2$. Numbered equation:
\begin{equation}
  \label{eq:ieee}
  \int_0^1 x^2 \, dx = \frac{1}{3}.
\end{equation}
Refer to Eq.~\ref{eq:ieee}. Figure~\ref{fig:ieee} and Table~\ref{tab:ieee} are placeholders. Cite as \cite{b1}. Footnote example\footnote{Footnote text.}
\begin{figure}[htbp]
  \centering
  \rule{3.5cm}{2cm}
